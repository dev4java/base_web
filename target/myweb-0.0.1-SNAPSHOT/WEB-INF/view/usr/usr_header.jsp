<div class="container-fluid">
				...
				<img alt="" src="/media/image/menu-toggler.png">
				...
				<ul class="nav pull-right">
					...
					<li id="header_inbox_bar" class="dropdown">
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li>
								...
								<span class="photo"><img alt="" src="/media/image/avatar2.jpg"></span>
							...
							<li>
								...
								<span class="photo"><img alt="" src=".//media/image/avatar3.jpg"></span>
							...
							<li>
								...
								<span class="photo"><img alt="" src=".//media/image/avatar1.jpg"></span>
					...
					<li class="dropdown user">
						...
						<img src="/media/image/avatar1_small.jpg" alt="">
